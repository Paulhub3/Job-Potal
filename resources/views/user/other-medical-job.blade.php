...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="p-4 sm:flex sm:items-center sm:justify-between">
            <h1 class="text-xl font-semibold text-gray-900">Medical Professional Applications</h1>
...
if(searchInput) {
    searchInput.addEventListener('input', function() {
        ...
        searchTimer = setTimeout(function() {
            ...
            var url = "{{ route('other-medical-job.index') }}?search=" + encodeURIComponent(searchTerm);
