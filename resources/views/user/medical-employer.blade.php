...
<div class="container mx-auto py-6">
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="p-4 sm:flex sm:items-center sm:justify-between">
            <h1 class="text-xl font-semibold text-gray-900">Medical Employer Listings</h1>
        ...
        <div class="p-4 border-t border-gray-200 flex items-center bg-gray-50">
            <div class="text-sm text-blue-700 font-medium">Total Job Listings: {{ $totalEmployers }}</div>
        </div>

        <div class="overflow-x-auto" id="searchResults">
            <x-medical-employer-table
            :employers="$employers"
...
if(searchInput) {
    searchInput.addEventListener('input', function() {
        ...
        searchTimer = setTimeout(function() {
            ...
            var url = "{{ route('medical-employer.index') }}?search=" + encodeURIComponent(searchTerm);
